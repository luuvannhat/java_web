...
<head>
	...
	<link
		...
		rel="stylesheet">
	<!-- NProgress -->
	<link href="${base }/Admin/vendors/nprogress/nprogress.css"
		rel="stylesheet">
	<!-- iCheck -->
	...
	<link
		...
		rel="stylesheet">
	<!-- JQVMap -->
	<link href="${base }/Admin/vendors/jqvmap/dist/jqvmap.min.css"
		rel="stylesheet" />
...
<body class="nav-md">
	<div class="container body">
		<div class="main_container">
			...
			<!-- right content -->	
			<jsp:include page="/WEB-INF/views/administrator/layout/right.jsp"></jsp:include>
