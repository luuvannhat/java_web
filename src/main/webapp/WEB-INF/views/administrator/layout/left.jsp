	...
	<div class="left_col scroll-view">
		...
		<div class="profile clearfix">
			<div class="profile_pic">
				<img src="${base }/Admin/images/img.jpg" alt="..."
		...
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					<li><a href="${base }/admin/home"><i class="fa fa-home"></i> Home <span
					...
					<li><a> <i class="fa fa-edit"></i> Quản lý <span
						...
						<ul class="nav child_menu">
							...
							<li><a href="form_advanced.html">Quản lý khách hàng</a></li>

							<li><a>Quản lý sản phẩm<span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu">
									<li><a href="${base }/admin/productadd">Thêm sản phẩm</a></li>
									<li><a href="${base }/admin/product/list">Danh sách sản phẩm</a></li>
								</ul>
							</li>
							...
							<li><a href="form_wizards.html">Quản lý hóa đơn</a></li>
							<li><a href="form_upload.html">Quản lý chất liệu</a></li>
